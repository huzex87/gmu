...
├── 04_WORLD_BIBLE/           GMU-004 — World Bible + all worldbuilding sub-bibles (all 14 drafted)
...
│   ├── MASTER_ENCYCLOPEDIA/  GMU-320 — Schema + 54 entries (Places, People, Objects, Events, Culture, Flora/Fauna, Institutions)
...
├── 17_AI_PRODUCTION/         GMU-006 — AI Production Bible
...
| GMU-004 | World Bible (+ sub-bibles) | 350+ | **In Progress** — 3 kingdoms, timeline, central conflict, religious basis (Islam) drafted; **all 14 sub-bibles now drafted** (2026-07-11) |
...
This local repository is the offline source of truth in the meantime — push it to a private GitHub org (`GMU Studio`) when ready, split by repo (`gmu-charter`, `gmu-world-bible`, `gmu-